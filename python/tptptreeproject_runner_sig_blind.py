...
def run_treeproject_and_plot(base_path, output_dir):
    tc = varial.tools.ToolChain(
        ...
        [
            ...
            varial.tools.ToolChain(
                'Inputs', [
                    treeproject_tptp.mk_tp(base_path, sideband_regions, treeproject_tptp.samples, name='TreeProjectorSideband'),
                    treeproject_tptp.mk_tp(base_path, signal_regions, treeproject_tptp.samples_no_data, name='TreeProjectorSignal'),
            ...
            varial.tools.ToolChain(
                'Histograms',
                [
                    plot.mk_toolchain('HistogramsAll', [output_dir+'/Inputs/TreeProjector*/*.root'], None, plot.samples_to_plot_final),
                    # sensitivity.mk_tc('LimitsCheckPar', mk_limit_list_dpg), # , output_dir+'/Inputs/SysTreeProjectors/*/*.root'
