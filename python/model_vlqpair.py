...
def get_model(hist_dir, final_states):
    ...
    model.add_lognormal_uncertainty('qcd_rate', math.log(2.00), 'QCD')
    model.add_lognormal_uncertainty('wjets_rate', math.log(1.25), 'WJets')
    model.add_lognormal_uncertainty('zjets_rate', math.log(2.00), 'DYJets')
    model.add_lognormal_uncertainty('singlet_rate', math.log(2.00), 'SingleTop')
    model.add_lognormal_uncertainty('luminosity', math.log(1.046), 'TTbar')
    model.add_lognormal_uncertainty('luminosity', math.log(1.046), 'QCD')
    model.add_lognormal_uncertainty('luminosity', math.log(1.046), 'WJets')
    model.add_lognormal_uncertainty('luminosity', math.log(1.046), 'DYJets')
    model.add_lognormal_uncertainty('luminosity', math.log(1.046), 'SingleTop')
