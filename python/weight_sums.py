...
smpls = glob.glob('/nfs/dust/cms/user/nowatsd/sFrameNew/RunII_76X_v1/CMSSW_7_6_3/src/UHH2/VLQToHiggsPairProd/NewSamples-76X-v1/FinalSelection-v24/Files_and_Plots/Files_and_Plots_nominal/SFrame/workdir/uhh2.AnalysisModuleRunner.MC.TpTp_M*.root')
pdf_offset = 110
...
smpl_grps = list(list(g) for _, g in itertools.groupby(smpls, get_basename_ht_rew))
