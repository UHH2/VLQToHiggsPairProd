...
class TpTpTriggerStudy: public TpTpAnalysisModule {
public:
    ...
    explicit TpTpTriggerStudy(Context & ctx);
...
TpTpTriggerStudy::TpTpTriggerStudy(Context & ctx) : TpTpAnalysisModule(ctx) {
    ...
    for (auto const & cat : categories) {
        ...
        if (cat == "NoSelection") {
        ...
        else if (cat == "isoMuo20cut25") {
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatF("primary_muon_pt_iso", "Primary Muon p_{T}", 60, 0., 1200., 25.));
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatI("trigger_accept_isoMu20", "Trigger Accept", 2, -.5, 1.5, 1));
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatF("pt_ld_ak4_jet", "Pt leading Ak4 Jet", 60, 0., 1500.));
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatF("pt_subld_ak4_jet", "Pt subleading Ak4 Jet", 60, 0., 1500.));
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatF("primary_lepton_pt", "Primary Lepton p_{T}", 60, 0., 1200.));
        ...
        else if (cat == "isoEle27cut30") {
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatF("primary_electron_pt_iso", "Primary Electron p_{T}", 60, 0., 1200., 30.));
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatI("trigger_accept_isoEl27", "Trigger Accept", 2, -.5, 1.5, 1));
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatI("trigger_accept_isoMu20", "Trigger Accept", 2, -.5, 1.5, 0, 0));
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatF("pt_ld_ak4_jet", "Pt leading Ak4 Jet", 60, 0., 1500.));
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatF("pt_subld_ak4_jet", "Pt subleading Ak4 Jet", 60, 0., 1500.));
        ...
        else if (cat == "mu45cut55") {
            
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatF("primary_muon_pt", "Primary Muon p_{T}", 60, 0., 1200., 55.));
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatI("trigger_accept_mu45", "Trigger Accept", 2, -.5, 1.5, 1));
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatF("pt_ld_ak4_jet", "Pt leading Ak4 Jet", 60, 0., 1500.));
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatF("pt_subld_ak4_jet", "Pt subleading Ak4 Jet", 60, 0., 1500.));
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatI("trigger_accept_el45", "Trigger Accept", 2, -.5, 1.5));
            ...
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatF("pt_subld_ak4_jet", "Pt subleading Ak4 Jet", 60, 0., 1500., 70.));
        ...
        else if (cat == "el45cut55") {
            
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatF("primary_electron_pt", "Primary Electron p_{T}", 60, 0., 1200., 60.));
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatF("pt_ld_ak4_jet", "Pt leading Ak4 Jet", 60, 0., 1500., 250.));
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatF("pt_subld_ak4_jet", "Pt subleading Ak4 Jet", 60, 0., 1500., 70.));
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatI("trigger_accept_el45", "Trigger Accept", 2, -.5, 1.5, 1));
            SEL_ITEMS_FULL_SEL.back().emplace_back(new SelDatI("trigger_accept_mu45", "Trigger Accept", 2, -.5, 1.5, 0, 0));
        ...
        map<string, TriggerEffHists*> trigger_eff_hists;
        // trigger_eff_hists["TriggerEff"] = new TriggerEffHists(ctx, cat+"/TriggerEff", *sel_helpers.back(), {"primary_muon_pt", "primary_electron_pt","pt_ld_ak4_jet", "pt_subld_ak4_jet"}, {triggername});



        // append 2D cut
        float dr_2d, dpt_2d;
        if (cat.find("iso") != std::string::npos || cat.find("Iso") != std::string::npos) {
            dr_2d = 0.;
            dpt_2d = 0.;
        }
        else {
        ...
        // }
        for (auto hist : trigger_eff_hists) {
            hist.second->insert_sel(pos_2d_cut, "twoD_cut");
            // if (cat == "MuElComb") {
            //     hist.second->insert_hist_and_sel(pos_2d_cut-1, new HandleHist<float>(ctx, cat+"/"+hist.first, "pt_ld_ak4_jet", "Pt leading Ak4 Jet", 60, 0., 1500.), "pt_ld_ak4_jet");
            //     hist.second->insert_hist_and_sel(pos_2d_cut-1, new HandleHist<float>(ctx, cat+"/"+hist.first, "pt_subld_ak4_jet", "Pt subleading Ak4 Jet", 60, 0., 1500.), "pt_subld_ak4_jet");
            // }
...
bool TpTpTriggerStudy::process(Event & event) {
...
UHH2_REGISTER_ANALYSIS_MODULE(TpTpTriggerStudy)
