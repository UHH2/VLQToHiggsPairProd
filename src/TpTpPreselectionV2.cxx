...
TpTpPreselectionV2::TpTpPreselectionV2(Context & ctx) : TpTpAnalysisModule(ctx) {
    ...
    other_modules.emplace_back(new PartPtProducer<TopJet>(ctx, "ak8jets_uncleaned", "pt_ld_ak8_jet_uncleaned", 1));
    // other_modules.emplace_back(new CollectionProducer<TopJet>(ctx,
    //             "ak8_boost",
    //             "ak8_boost_2b",
    ...
    std::vector<string> categories = {"IsoMuo24-clean", "Mu45-clean", "Mu15_PFHT600-clean", "PFHT800-clean", "PFHT800-uncleaned"}; // "NoSelection"
    ...
    for (auto const & cat : categories) {
        ...
        else if (split(cat, "-")[0] == "Mu15_PFHT600") {
