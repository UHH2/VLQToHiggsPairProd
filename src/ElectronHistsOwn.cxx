...
ElectronHists::ElectronHists(Context & ctx, const std::string & dname, bool gen_plots): Hists(ctx, dname){
    ...
    isolation   = book<TH1F>("isolation",   "relIso electron",          200,0,10);
    ...
    isolation_1 = book<TH1F>("isolation_1", "relIso electron 1",        200,0,10);
    ...
    isolation_2 = book<TH1F>("isolation_2", "relIso electron 2",        200,0,10);
