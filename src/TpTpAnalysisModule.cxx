...
static const vector<shared_ptr<SelectionItem>> SEL_ITEMS_BASELINE_SEL {
    ...
    shared_ptr<SelectionItem>(new SelDatI("n_higgs_tags", "N(Higgs-Tags)", 5, -.5, 4.5, 1)),
    ...
    for (auto const & cat : categories) {
        ...
        if (cat == "NoSelection") {
            ...
            if (type == "MC")
                ...
                other_modules.emplace_back(new TriggerAcceptProducer(ctx, {"HLT_IsoMu27_v*"}, "trigger_accept_"+cat));
