...
static const vector<shared_ptr<SelectionItem>> SEL_ITEMS_VLQPair_tight_base {
    ...
    shared_ptr<SelectionItem>(new SelDatF("mass_ld_higgs_tag_ak8",  "Mass ld Higgs tag (AK8)",                25,   0, 500                )),
    shared_ptr<SelectionItem>(new SelDatF("mass_ld_higgs_tag_ca15_notop", "Mass ld Higgs tag (CA15), no top", 25,   0, 500                )),
    shared_ptr<SelectionItem>(new SelDatF("mass_ld_higgs_tag_ak8_notop",  "Mass ld Higgs tag (AK8), no top",  25,   0, 500                )),
