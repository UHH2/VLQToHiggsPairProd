...
static const vector<shared_ptr<SelectionItem>> SEL_ITEMS_VLQPair_tight_base {
    ...
    shared_ptr<SelectionItem>(new SelDatF("min_deltaR_top_higgsca8","min deltaR(top, higgs)",                 20,   0, 5.                 )),
    shared_ptr<SelectionItem>(new SelDatF("min_deltaR_top_higgsca8notop","min deltaR(top, higgs(separated))", 20,   0, 5.                 )),
    shared_ptr<SelectionItem>(new SelDatF("min_deltaR_top_higgsca8_twotop","min deltaR(top, higgs, two tops)",                 20,   0, 5.                 )),
    shared_ptr<SelectionItem>(new SelDatF("min_deltaR_top_higgsca8notop_twotop","min deltaR(top, higgs(separated), two tops)", 20,   0, 5.                 )),
